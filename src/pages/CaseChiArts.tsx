        ...
        <div className="mx-auto max-w-3xl text-center">
          <motion.div {...fadeUp}>
            ...
            <p className="mb-6 text-lg leading-relaxed text-neutral-400">
              I saw a problem that involved people I care about, in an institution I believe in, in a city I know well. I didn't wait to be asked. I defined the product, did the research, designed the UX, and built it — start to shipped — because that's what the situation required.
            </p>
